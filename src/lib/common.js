 ...
 * todo:
 * - Протестировать:
 *  - существующие и не существующие слова русского и англ. языков;
 *  - все типы хранилищ;
 *  - все типы предсказаний и режимов работы;
 *  - все методы со всеми вариантоами параметрамов
 *  - разные кодировки (для win1251 и у англ. словарей своя кодировка)
//*/
